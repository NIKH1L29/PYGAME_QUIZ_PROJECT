...
class Game:
	...
	def __init__(self):
		...
		self.questions = [Question_Object(data["question"][0], (data["answer 1"][0], data["answer 2"][0], data["answer 3"][0], data["answer 4"][0]), data["correct_answer"][0]-1),
                          Question_Object(data["question"][1], (data["answer 1"][1], data["answer 2"][1], data["answer 3"][1], data["answer 4"][1]), data["correct_answer"][1]-1),
                          Question_Object(data["question"][2], (data["answer 1"][2], data["answer 2"][2], data["answer 3"][2], data["answer 4"][2]), data["correct_answer"][2]-1),
                          Question_Object(data["question"][3], (data["answer 1"][3], data["answer 2"][3], data["answer 3"][3], data["answer 4"][3]), data["correct_answer"][3]-1),
                          Question_Object(data["question"][4], (data["answer 1"][4], data["answer 2"][4], data["answer 3"][4], data["answer 4"][4]), data["correct_answer"][4]-1)
                          ]
